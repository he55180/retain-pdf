...
#let rp0_item_p001_b002_0_md = "达累斯萨拉姆海运门户项目（DMGP）"
...
#let rp0_item_p001_b004_1_md = "达累斯萨拉姆港滚装船码头及1-7号泊位混凝土损伤修复"
...
#let rp0_item_p001_b005_2_md = "第15次周会议记录"
...
#let rp0_item_p001_b007_4_md = "MoM-第15次周例会-2026/5/14"
...
#let rp0_item_p001_b010_6_md = "星期四，2026年5月14日 / 14:35"
...
#let rp0_item_p001_b014_10_md = "见所附清单"
...
#let rp0_item_p001_b019_14_md = "总干事 - TPA"
...
#let rp0_item_p001_b033_20_md = "承包商开工准备"
...
#let rp0_item_p001_b037_24_md = "PM 设施"
...
#let rp0_item_p001_b044_31_md = "预制构件及存放区"
...
#let rp0_item_p001_b049_36_md = "驻地工程师——RE（IL - Eng. José Rodrigues）致欢迎辞并宣布会议开始。本次会议由驻地工程师代表工程师主持。"
...
#let rp1_item_p002_b002_0_md = "达累斯萨拉姆海运门户项目（DMGP）"
...
#let rp1_item_p002_b004_1_md = "达累斯萨拉姆港滚装船码头及1-7号泊位混凝土损伤修复"
...
#let rp1_item_p002_b010_5_md = "承包商开工准备"
...
#let rp1_item_p002_b011_6_md = "关于现场可进入性，驻地工程师向会议通报，正如2026年5月12日三方会议所报告的，目前在港口内获得工作空间仍然困难。尽管如此，雇主承诺将持续与DP World跟进，一旦时机合适便为承包商分配场地。随后，会议同意TPA将安排DP World提前为承包商工人办理港口通行证，以便在条件允许开工时便于进场。"
#let rp1_item_p002_b011_6_body = block(width: 323.84684201329947pt, height: 114.45554787218569pt)[#{ pdftr_fit_markdown(rp1_item_p002_b011_6_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 114.45554787218569pt) }]
#context {
  place(top + left, dx: 113.11003810539842pt, dy: 186.3722868695855pt, rp1_item_p002_b011_6_body)
}
#let rp1_item_p002_b012_7_md = "关于路面砖，承包商被要求提供代表性样品以及来自实际生产（用于现场施工）的验证测试结果。承包商在会上告知，他找不到一家信誉良好的"
...
#context {
  place(top + left, dx: 116.7330998338759pt, dy: 253.15446044847369pt, rp1_item_p002_b012_7_body)
}
#let rp1_item_p002_b013_8_md = "国内具备进行抗滑试验能力的实验室，因此请求驻地工程师协助在坦桑尼亚寻找能进行该试验的实验室。"
...
#context {
  place(top + left, dx: 114.83075625300407pt, dy: 377.868909430027pt, rp1_item_p002_b013_8_body)
}
#let rp1_item_p002_b014_9_md = "RE已承诺调查该问题并将据此给出建议。同时，工程师正在分析承包商提交的劈裂拉伸试验结果，并将在不久后给出答复。"
...
#context {
  place(top + left, dx: 114.13091826960445pt, dy: 429.01692851138114pt, rp1_item_p002_b014_9_body)
}
#let rp1_item_p002_b015_10_md = "信息"
#let rp1_item_p002_b015_10_body = block(width: 31.382359832525253pt, height: 15.386403315365328pt)[#{ pdftr_fit_markdown(rp1_item_p002_b015_10_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 15.386403315365328pt) }]
#context {
  place(top + left, dx: 483.2007413059473pt, dy: 201.9183751900494pt, rp1_item_p002_b015_10_body)
}
#let rp1_item_p002_b017_11_md = "信息"
#let rp1_item_p002_b017_11_body = block(width: 31.69473972916603pt, height: 15.68180924773219pt)[#{ pdftr_fit_markdown(rp1_item_p002_b017_11_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 15.68180924773219pt) }]
#context {
  place(top + left, dx: 483.186477586627pt, dy: 343.46676480710505pt, rp1_item_p002_b017_11_body)
}
#let rp1_item_p002_b020_12_md = "合同事宜"
#let rp1_item_p002_b020_12_body = block(width: 97.52413131892682pt, height: 14.628606791496281pt)[#{ pdftr_fit_markdown(rp1_item_p002_b020_12_md, max_size: 14.05pt, min_size: 11.85pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 14.628606791496281pt) }]
#context {
  place(top + left, dx: 108.33830298930407pt, dy: 485.8167598195076pt, rp1_item_p002_b020_12_body)
}
#let rp1_item_p002_b022_13_md = "劳动力、材料和设备"
#let rp1_item_p002_b022_13_body = block(width: 196.3035373315215pt, height: 14.730808134078984pt)[#{ pdftr_fit_markdown(rp1_item_p002_b022_13_md, max_size: 14.15pt, min_size: 11.95pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 14.730808134078984pt) }]
#context {
  place(top + left, dx: 110.44966930523515pt, dy: 504.8062454111576pt, rp1_item_p002_b022_13_body)
}
#let rp1_item_p002_b023_14_md = "驻地工程师再次提醒承包商，按照合同中经批准的人员清单，提交一份所有员工（包括本地和外国员工）的名单。"
#let rp1_item_p002_b023_14_body = block(width: 321.9701423928142pt, height: 36.89545999288555pt)[#{ pdftr_fit_markdown(rp1_item_p002_b023_14_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 36.89545999288555pt) }]
#context {
  place(top + left, dx: 114.88747379258275pt, dy: 524.4264999933243pt, rp1_item_p002_b023_14_body)
}
#let rp1_item_p002_b024_15_md = "关于外籍员工，驻地工程师提醒承包商提交护照入境许可副本，以证明其被允许入境并在该国工作。承包商承诺在2026年5月21日的下次会议前提交。"
#let rp1_item_p002_b024_15_body = block(width: 322.38400354236364pt, height: 29.377478638172178pt)[#{ pdftr_fit_markdown(rp1_item_p002_b024_15_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 29.377478638172178pt) }]
#context {
  place(top + left, dx: 114.70213875547051pt, dy: 566.5286692447662pt, rp1_item_p002_b024_15_body)
}
#let rp1_item_p002_b025_16_md = "关于已调运的设备，驻地工程师询问有故障的压缩机是否已修复。承包商告知会议，他仍在等待从中国订购的备件，预计于2026年5月底前到货。"
#let rp1_item_p002_b025_16_body = block(width: 324.9979056477547pt, height: 40.9006447725295pt)[#{ pdftr_fit_markdown(rp1_item_p002_b025_16_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 40.9006447725295pt) }]
#context {
  place(top + left, dx: 113.44887290596962pt, dy: 640.6474496939182pt, rp1_item_p002_b025_16_body)
}
#let rp1_item_p002_b026_17_md = "关于混凝土配合比设计，承包商已提交28天结果，工程师正在核查并将据此回复。"
#let rp1_item_p002_b026_17_body = block(width: 321.05247719734905pt, height: 27.050792322158713pt)[#{ pdftr_fit_markdown(rp1_item_p002_b026_17_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 27.050792322158713pt) }]
#context {
  place(top + left, dx: 114.78263027146458pt, dy: 725.5579488418102pt, rp1_item_p002_b026_17_body)
}
#let rp1_item_p002_b032_18_md = "PM设施"
#let rp1_item_p002_b032_18_body = block(width: 66.58909386992455pt, height: 15.064830315113113pt)[#{ pdftr_fit_markdown(rp1_item_p002_b032_18_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 15.064830315113113pt) }]
#context {
  place(top + left, dx: 105.81667959392071pt, dy: 755.7276584515571pt, rp1_item_p002_b032_18_body)
}
#let rp1_item_p002_b033_19_md = "驻地工程师告知会议，TPA方面没有提供最新情况。"
#let rp1_item_p002_b033_19_body = block(width: 307.6704038485884pt, height: 8.822366440296264pt)[#{ pdftr_fit_markdown(rp1_item_p002_b033_19_md, max_size: 11.74pt, min_size: 10.94pt, max_leading: 0.59em, min_leading: 0.51em, fit_height: 8.822366440296264pt) }]
#context {
  place(top + left, dx: 112.18370507135987pt, dy: 775.9448760995864pt, rp1_item_p002_b033_19_body)
}
#let rp1_item_p002_b036_20_md = "每日、每周和每月报告"
#let rp1_item_p002_b036_20_body = block(width: 175.87339256480334pt, height: 14.871282117366718pt)[#{ pdftr_fit_markdown(rp1_item_p002_b036_20_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 14.871282117366718pt) }]
#context {
  place(top + left, dx: 109.39592574648559pt, dy: 794.7024831161499pt, rp1_item_p002_b036_20_body)
}
#let rp1_item_p002_b037_21_md = "驻地工程师告知会议，承包商正按照合同要求提交相应报告。每周报告应按周提交，周期为周一至周日。"
#let rp1_item_p002_b037_21_body = block(width: 321.14613488167527pt, height: 52.39792350530615pt)[#{ pdftr_fit_markdown(rp1_item_p002_b037_21_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 52.39792350530615pt) }]
#context {
  place(top + left, dx: 115.00561234429479pt, dy: 814.8177378664017pt, rp1_item_p002_b037_21_body)
}
#pagebreak()
#set page(width: 595.3200073242188pt, height: 841.9200439453125pt, margin: 0pt, fill: none)
#place(top + left, dx: 0pt, dy: 0pt, image("book-background-cleaned.pdf", page: 3, width: 595.3200073242188pt))
#let rp2_item_p003_b002_0_md = "达累斯萨拉姆海运门户项目（DMGP）"
...
#let rp2_item_p003_b004_1_md = "达累斯萨拉姆港滚装船码头及1-7号泊位混凝土损伤修复"
...
#let rp2_item_p003_b010_4_md = "关于新缺陷，驻地工程师在会上告知，雇主就拟与各方进行的联合检查（以确定相对于合同中所识别裂缝的新裂缝）仍未提供任何最新消息。"
...
#let rp2_item_p003_b013_5_md = "弃土区"
...
#let rp2_item_p003_b014_6_md = "关于卸料区，承包商仍在等待TPA的正式通知。"
...
#let rp2_item_p003_b018_8_md = "TPA / 急救设施\n\n承包商与工程师已于4月10日在供应商处对第三个急救室集装箱进行联合检查，确认其满足需求。承包商在会上告知，一旦收到来自中国用于支付制造及运至现场的资金，该集装箱将于2026年5月底前运抵现场。"
...
#let rp2_item_p003_b022_10_md = "驻地工程师在会上告知，观察到周围环境已有可喜改善，即使在近期降雨期间也未闻到任何异味。"
...
#let rp2_item_p003_b025_11_md = "预制构件及存储区"
...
#let rp2_item_p003_b026_12_md = "关于港区内预制构件的存放空间需求，承包商告知会议，其已决定从港区外购预制构件，因此不再像先前讨论中那样急需获得港区内的场地。"
...
#let rp2_item_p003_b027_13_md = "驻地工程师再次指示承包商书面说明其不再需要该设施。承包商承诺在2026年5月21日下次会议前提交书面文件。"
...
#let rp2_item_p003_b031_15_md = "集装箱堆场港口照明"
...
#let rp2_item_p003_b032_16_md = "承包商提交了建议采用410瓦照明的方案，但驻地工程师告知设计要求为1000瓦。驻地工程师表示已收到承包商提交的关于港口拟用灯具的支撑文件，将予以审查并相应回复承包商。"
...
#let rp2_item_p003_b035_17_md = "承包商开票"
...
#let rp2_item_p003_b036_18_md = "驻地工程师建议承包商核实当前已支出金额是否低于或高于合同规定的开具发票所需的最低金额（2%）。"
...
#let rp3_item_p004_b002_0_md = "达累斯萨拉姆海运门户项目（DMGP）"
...
#let rp3_item_p004_b004_1_md = "达累斯萨拉姆港滚装船码头及1-7号泊位混凝土损伤修复"
...
#let rp3_item_p004_b007_4_md = "工程师程永建"
...
#let rp3_item_p004_b010_7_md = "工程师 José Rodrigues"
#let rp3_item_p004_b010_7_body = block(width: 99.93123803749519pt, height: 9.163117730704982pt)[#{ pdftr_fit_markdown(rp3_item_p004_b010_7_md, max_size: 8.8pt, min_size: 7.2pt, max_leading: 0.29em, min_leading: 0.18em, fit_height: 9.163117730704982pt) }]
#context {
  place(top + left, dx: 65.02976717203934pt, dy: 341.5874782275757pt, rp3_item_p004_b010_7_body)
}
#let rp3_item_p004_b011_8_md = "驻地工程师"
#let rp3_item_p004_b011_8_body = block(width: 88.93088513794926pt, height: 9.163117730704982pt)[#{ pdftr_fit_markdown(rp3_item_p004_b011_8_md, max_size: 8.8pt, min_size: 7.2pt, max_leading: 0.29em, min_leading: 0.18em, fit_height: 9.163117730704982pt) }]
#context {
  place(top + left, dx: 64.74028420099866pt, dy: 358.62747897757566pt, rp3_item_p004_b011_8_body)
}
#let rp3_item_p004_b012_9_md = "致工程师 - IL"
#let rp3_item_p004_b012_9_body = block(width: 116.7325926885352pt, height: 9.150320080243034pt)[#{ pdftr_fit_markdown(rp3_item_p004_b012_9_md, max_size: 8.79pt, min_size: 7.2pt, max_leading: 0.29em, min_leading: 0.18em, fit_height: 9.150320080243034pt) }]
#context {
  place(top + left, dx: 65.47190808390882pt, dy: 375.7981147419227pt, rp3_item_p004_b012_9_body)
}
#let rp3_item_p004_b013_10_md = "5.0 会议闭幕"
#let rp3_item_p004_b013_10_body = block(width: 147.34pt, height: 9.61pt)[#{ pdftr_fit_single_line_markdown(rp3_item_p004_b013_10_md, max_size: 8.79pt, min_size: 7.2pt, fit_width: 147.34pt, fit_height: 9.61pt, weight: "bold") }]
#context {
  place(top + left, dx: 84.81278392127506pt, dy: 153.21810049192266pt, rp3_item_p004_b013_10_body)
}
#let rp3_item_p004_b014_11_md = "由于没有其他事项，会议于14:56宣布结束。"
#let rp3_item_p004_b014_11_body = block(width: 321.96080078425814pt, height: 21.007119845705006pt)[#{ pdftr_fit_markdown(rp3_item_p004_b014_11_md, max_size: 11.73pt, min_size: 10.93pt, max_leading: 0.69em, min_leading: 0.61em, fit_height: 21.007119845705006pt) }]
#context {
  place(top + left, dx: 115.63265640221734pt, dy: 173.2454730450757pt, rp3_item_p004_b014_11_body)
}
#let rp3_item_p004_b015_12_md = "全体"
#let rp3_item_p004_b015_12_body = block(width: 21.49398364549819pt, height: 9.16311773070504pt)[#{ pdftr_fit_markdown(rp3_item_p004_b015_12_md, max_size: 8.8pt, min_size: 7.2pt, max_leading: 0.29em, min_leading: 0.18em, fit_height: 9.16311773070504pt) }]
#context {
  place(top + left, dx: 491.36564914856575pt, dy: 172.8674729775757pt, rp3_item_p004_b015_12_body)
}
#pagebreak()
#set page(width: 595.3200073242188pt, height: 841.9200439453125pt, margin: 0pt, fill: none)
#place(top + left, dx: 0pt, dy: 0pt, image("book-background-cleaned.pdf", page: 5, width: 595.3200073242188pt))
#let rp4_item_p005_b003_0_md = "达累斯萨拉姆海运门户项目（DMGP）"
...
#let rp4_item_p005_b004_1_md = "合同编号：TZ-TPA-/424013-CW-DIR 达累斯萨拉姆港滚装船泊位及1–7号泊位混凝土损伤修复"
