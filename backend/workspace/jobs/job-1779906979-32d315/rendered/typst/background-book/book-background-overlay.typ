...
#let rp0_item_p001_b000_0_body = block(width: 180.93099999999998pt, height: 16.997pt)[#{ pdftr_fit_markdown(rp0_item_p001_b000_0_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 16.997pt) }]
#context {
  place(top + left, dx: 96.464pt, dy: 79.99pt, rp0_item_p001_b000_0_body)
}
#pagebreak()
#set page(width: 595.2755737304688pt, height: 841.8897705078125pt, margin: 0pt, fill: none)
...
#let rp1_item_p002_b000_0_body = block(width: 183.931pt, height: 17.497pt)[#{ pdftr_fit_markdown(rp1_item_p002_b000_0_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.3em, min_leading: 0.18em, fit_height: 17.497pt) }]
#context {
  place(top + left, dx: 96.963pt, dy: 79.99pt, rp1_item_p002_b000_0_body)
}
