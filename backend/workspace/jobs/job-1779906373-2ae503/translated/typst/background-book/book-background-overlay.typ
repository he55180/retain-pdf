...
#set page(width: 595.2755737304688pt, height: 841.8897705078125pt, margin: 0pt, fill: none)
#place(top + left, dx: 0pt, dy: 0pt, image("book-background-cleaned.pdf", page: 1, width: 595.2755737304688pt))
#let rp0_item_p001_b000_0_md = "第 1 页 - 这是一份测试文档。"
#let rp0_item_p001_b000_0_body = block(width: 166.64520000000016pt, height: 10.434000000000026pt)[#{ pdftr_fit_markdown(rp0_item_p001_b000_0_md, max_size: 10.02pt, min_size: 7.82pt, max_leading: 0.29em, min_leading: 0.18em, fit_height: 10.434000000000026pt) }]
#context {
  place(top + left, dx: 104.3854pt, dy: 83.60680000000005pt, rp0_item_p001_b000_0_body)
}
#pagebreak()
#set page(width: 595.2755737304688pt, height: 841.8897705078125pt, margin: 0pt, fill: none)
#place(top + left, dx: 0pt, dy: 0pt, image("book-background-cleaned.pdf", page: 2, width: 595.2755737304688pt))
#let rp1_item_p002_b000_0_md = "第2页 - 这是第二页。"
#let rp1_item_p002_b000_0_body = block(width: 169.8258000000001pt, height: 10.434000000000026pt)[#{ pdftr_fit_markdown(rp1_item_p002_b000_0_md, max_size: 10.02pt, min_size: 7.82pt, max_leading: 0.29em, min_leading: 0.18em, fit_height: 10.434000000000026pt) }]
#context {
  place(top + left, dx: 104.4691pt, dy: 83.60680000000005pt, rp1_item_p002_b000_0_body)
}
