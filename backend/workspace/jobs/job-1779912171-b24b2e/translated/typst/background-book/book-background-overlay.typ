...
#let rp0_item_p002_b004_1_md = "达累斯萨拉姆港滚装船泊位及1-7号泊位混凝土损伤修复"
...
#let rp0_item_p002_b006_2_md = "项目"
...
#let rp0_item_p002_b011_6_md = "关于场地通行问题，RE在会上通报，正如2026年5月12日三方会议所报告，目前在港区内获取作业场地仍存在困难。尽管如此，业主承诺将继续与DP World保持跟进，一旦条件合适即为承包商分配场地。随后，会议同意TPA将协调DP World提前为承包商工人发放港口通行证，以便在情况允许开工时顺利进场。"
...
#let rp0_item_p002_b012_7_md = "关于铺路砖，承包商被要求提供代表性样品以及源自拟用于现场施工的实际生产的经验证测试结果。承包商告知会议，其未能找到一家信誉良好的"
...
#let rp0_item_p002_b013_8_md = "该国具备进行抗滑性能测试能力的实验室，因此请求 RE 协助在坦桑尼亚寻找一家实验室来执行该项测试。"
...
#let rp0_item_p002_b014_9_md = "驻地工程师已承诺调查此事并将相应告知。同时，工程师正在分析承包商提交的劈裂抗拉试验结果，并将很快给出答复。"
...
#let rp0_item_p002_b023_12_md = "RE再次提醒承包商，应按照合同批准的员工名单，提交所有员工（包括本地和外国员工）名单。"
...
#let rp0_item_p002_b024_13_md = "关于外籍员工，驻地工程师提醒承包商提交护照入境许可副本，以证明其获准入境并在该国工作。承包商承诺在2026年5月21日的下次会议前提交。"
...
#let rp0_item_p002_b025_14_md = "关于已动员的设备，驻地工程师询问有缺陷的压缩机是否已修好。承包商告知会议，其仍在等待从中国订购的备件，预计于2026年5月底前到货。"
...
#let rp0_item_p002_b026_15_md = "关于混凝土配合比设计，承包商已提交了28天结果，工程师正在核查并将给予相应回复。"
...
#let rp0_item_p002_b033_17_md = "RE向会议通报，TPA方面无最新进展。"
...
#let rp0_item_p002_b036_18_md = "日报、周报和月报"
...
#let rp0_item_p002_b037_19_md = "驻地工程师（RE）在会上告知，目前已按照合同要求陆续收到承包商提交的报告。周报应按周期提交，覆盖周一至周日。"
...
#let rp1_item_p003_b004_1_md = "达累斯萨拉姆港滚装船泊位及1-7号泊位混凝土损伤修复"
...
#let rp1_item_p003_b007_2_md = "其他事项"
#let rp1_item_p003_b007_2_body = block(width: 29.13003042191268pt, height: 9.52708522254602pt)[#{ pdftr_fit_markdown(rp1_item_p003_b007_2_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 9.52708522254602pt) }]
#context {
  place(top + left, dx: 105.85322204306722pt, dy: 148.75651085597462pt, rp1_item_p003_b007_2_body)
}
...
#let rp1_item_p003_b010_4_md = "关于新缺陷，RE 向会议通报，雇主方面尚未更新关于拟与各方联合检查以确定与合同已识别裂缝相关的新裂缝的进展。"
...
#let rp1_item_p003_b014_6_md = "关于弃土区，承包商仍在等待TPA的正式通知。"
...
#let rp1_item_p003_b018_8_md = "第三个急救室集装箱已于4月10日由承包商和工程师在供应商现场联合检查，确认其满足需求。承包商在会上通报，一旦收到来自中国的用于制造和运输的资金，该集装箱将于2026年5月底前运抵现场。"
...
#let rp1_item_p003_b022_10_md = "RE向会议通报，观察到周边环境有显著改善，即使在最近的降雨期间也未闻到任何气味。"
...
#let rp1_item_p003_b025_11_md = "预制构件及存储区"
...
#let rp1_item_p003_b026_12_md = "关于港口内预制构件的场地需求，承包商告知会议，其已决定从港口外采购预制构件，因此先前讨论中关于获取港口内场地的紧迫性已不再必要。"
#let rp1_item_p003_b026_12_body = block(width: 322.3358660817146pt, height: 46.356065371513395pt)[#{ pdftr_fit_markdown(rp1_item_p003_b026_12_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 46.356065371513395pt) }]
#context {
  place(top + left, dx: 114.30627203583717pt, dy: 505.6366975376129pt, rp1_item_p003_b026_12_body)
}
#let rp1_item_p003_b027_13_md = "RE再次指示承包商书面表明其不再需要该设施。承包商承诺在2026年5月21日下次会议前提交书面确认。"
...
#context {
  place(top + left, dx: 114.57811290174723pt, dy: 597.2527883080959pt, rp1_item_p003_b027_13_body)
}
#let rp1_item_p003_b031_14_md = "集装箱码头堆场照明"
#let rp1_item_p003_b031_14_body = block(width: 206.67609069272874pt, height: 15.292837750911758pt)[#{ pdftr_fit_markdown(rp1_item_p003_b031_14_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 15.292837750911758pt) }]
#context {
  place(top + left, dx: 110.48236236460507pt, dy: 661.2055483250141pt, rp1_item_p003_b031_14_body)
}
#let rp1_item_p003_b032_15_md = "承包商提交的照明推荐功率为410瓦，但驻地工程师（RE）指出设计要求为1000瓦。RE告知已收到承包商提交的港口拟用光源支持文件，将对其进行审查并相应回复承包商。"
#let rp1_item_p003_b032_15_body = block(width: 323.5913518428803pt, height: 48.25544883298868pt)[#{ pdftr_fit_markdown(rp1_item_p003_b032_15_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 48.25544883298868pt) }]
#context {
  place(top + left, dx: 111.95159710645676pt, dy: 681.9208614639759pt, rp1_item_p003_b032_15_body)
}
#let rp1_item_p003_b035_16_md = "承包商发票"
#let rp1_item_p003_b035_16_body = block(width: 114.49790861643851pt, height: 15.294229495525315pt)[#{ pdftr_fit_markdown(rp1_item_p003_b035_16_md, max_size: 14.2pt, min_size: 12.0pt, max_leading: 0.28em, min_leading: 0.18em, fit_height: 15.294229495525315pt) }]
#context {
  place(top + left, dx: 107.04278207477182pt, dy: 774.0456830095768pt, rp1_item_p003_b035_16_body)
}
#let rp1_item_p003_b036_17_md = "驻地工程师建议承包商核实现有支出金额是否低于或高于合同规定的2%的最低开票金额要求。"
#let rp1_item_p003_b036_17_body = block(width: 320.28137727230785pt, height: 40.638873131275204pt)[#{ pdftr_fit_markdown(rp1_item_p003_b036_17_md, max_size: 11.7pt, min_size: 10.9pt, max_leading: 0.76em, min_leading: 0.68em, fit_height: 40.638873131275204pt) }]
#context {
  place(top + left, dx: 114.57902789786458pt, dy: 796.1175251817226pt, rp1_item_p003_b036_17_body)
}
