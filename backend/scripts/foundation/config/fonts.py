...
DEFAULT_FONT_PATH = Path(
    ...
    or str(BACKEND_FONTS_DIR / "SourceHanSansSC-Regular.otf")
)
TITLE_BOLD_FONT_PATH = Path(
    os.environ.get("RETAIN_PDF_TITLE_BOLD_FONT_PATH", "").strip()
    or str(BACKEND_FONTS_DIR / "SourceHanSansSC-Bold.otf")
)
DEFAULT_FONT_SIZE = 11.4
MIN_FONT_SIZE = 8.5
TYPST_DEFAULT_FONT_FAMILY = os.environ.get("RETAIN_PDF_TYPST_FONT_FAMILY", "").strip() or "Source Han Sans SC"
