    ...
    this.innerHTML = `
      <header class="topbar">
        ...
        <div class="hero-actions">
          <button id="developer-btn" type="button" class="secondary">开发者 / Developer</button>
          <button id="open-output-btn" type="button" class="secondary hidden">打开输出目录 / Open Output</button>
        </div>
      </header>
